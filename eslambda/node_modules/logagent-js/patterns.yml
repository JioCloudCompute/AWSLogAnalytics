...
- # Nova
  ...
  match:
    - type: nova_api
      ...
      fields: [ts,pid,severity,process,req,message,class,line]
      #properties : {class: {type : string, index: not_analyzed}}
      dateFormat: YYYY-MM-DD HH:mm:ss.SSS
      transform: !!js/function >
        function (p) {
          p.raw_req = p.req.replace(/[-\/]/g,"_")
          p.raw_class = p.class.replace(/[-\/]/g,"_")
          p.raw_process = p.process.replace(/[-\/]/g,"_")
        }
    - type: jio_compute
      ...
      fields: [ts,log_level,log_service,severity,service,metric_type,timestamp,metric_value,host,metric_name,req]
      #properties : {class: {type : string, index: not_analyzed}}
